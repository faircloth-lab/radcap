# -*- coding: utf-8 -*-
#
# radcap documentation build configuration file, created by
...
project = u'radcap'
copyright = u'2016, Brant C. Faircloth'
...
latex_documents = [
  ('index', 'radcap.tex', u'radcap documentation',
...
man_pages = [
    ('index', 'radcap', u'radcap documentation',
...
texinfo_documents = [
  ('index', 'radcap', u'radcap documentation',
   u'Brant C. Faircloth', 'radcap', 'Sequence capture based RADseq.',
   'Miscellaneous'),
]
